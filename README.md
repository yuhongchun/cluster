...
附注：因为书中的无论是Python脚本和YAML配置文件，代码量并不是很大，所以这里以章节的形式归类，比如1.5.3目录下面有1.py，表示这是1.5.3章节的第一个Python脚本，如果是2.py，则表示是第二个Python脚本。其它章节的脚本大家可以依此类推，在哪个章节出现的配置文件或脚本就在哪个章节去找，这样方便。<br>
